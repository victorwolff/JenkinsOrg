            ...
            */
            stage('Create Package Version') {
                if (isUnix()) {
                    ...
                    output = bat(returnStdout: true, script: "\"${toolbelt}\" force:package:version:create -p ${PACKAGE_NAME} -d force-app -k test1234 --wait 10 -v victorwolffjobs@curious-hawk-dyiifv.com").trim()
